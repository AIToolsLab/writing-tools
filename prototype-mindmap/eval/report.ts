...
async function main(): Promise<void> {
  ...
  const lines = [
    ...
    "## Human judgments", "",
    "| Level | Outcomes | Introduced concepts | Unstated relationships | Unraised directions | Composite directiveness | AI attribution when applicable | Questions with hidden premises | Questions with confusing quotations |",
    "| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
    ...judgments.map((summary) => `| L${summary.level} | ${summary.count} | ${ratioText(summary.introducedConcepts, summary.count)} | ${ratioText(summary.unstatedRelationships, summary.count)} | ${ratioText(summary.unraisedDirections, summary.count)} | ${ratioText(summary.directiveness, summary.count)} | ${ratioText(summary.attributedAiMaterial, summary.aiMaterialCases)} | ${ratioText(summary.questionPremises, summary.questionCases)} | ${ratioText(summary.confusingQuoteQuestions, summary.quoteQuestionCases)} |`),
