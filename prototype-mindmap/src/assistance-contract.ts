...
export const ASSISTANCE_CONTRACTS: Record<AssistanceLevel, AssistanceContract> = {
  0: {
    ...
    allowedResponseKinds: ["question", "reflection", "aside", "map_proposal"],
  ...
  1: {
    ...
    allowedResponseKinds: ["question", "reflection", "aside", "map_proposal", "options"],
  ...
  2: {
    ...
    allowedResponseKinds: ["question", "reflection", "aside", "map_proposal", "options", "suggestion"],
