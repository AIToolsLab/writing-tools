...
scenario_true = '''
# Your Role: 
You are a Marketing Coordinator leading your first major Q4 campaign. Your manager, David, has been championing your work to senior leadership.

#Campaign Context: 
David is scheduled to present your $50k campaign budget to the client tomorrow. Your plan allocates $30k to social and $20k to search to create a “search-to-social” funnel. 

#The Bad News: 
A recent meeting with Lisa (Finance Director) revealed a Q4 budget freeze and a significant cut to your campaign budget: it's now $35k (a 30% reduction). As a result, Lisa has stated that search ads must be eliminated entirely in favor of social ads.

#Impact: 
This means 40% less reach than promised. While Lisa floated the possibility of adding search ads back in Q1 (no guarantees), Tom (the Marketing Analyst) is concerned because the client specifically requested both channels.

#Your Task: 
Email David immediately to:
...
#Campaign Context: 
David is scheduled to present your $20k campaign budget to the client next week. Your plan allocates $10k to search and $10k to social to create a “search-to-social” funnel. 

#The Bad News: 
A recent meeting with Lisa (Finance Director) revealed a Q4 budget freeze and a significant raise to your campaign budget: it's now $35k (a 30% increase).

#Impact: 
This means 40% more reach than promised. Tom (the Marketing Analyst) is excited for both the client and David.

#Your Task: 
Email David when free to:
