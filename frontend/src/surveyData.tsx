...
export const english_proficiency = {
	text: 'How proficient would you say you are in English? (Be honest, no penalty here!)',
	responseType: 'options',
...
export const aiWritingTools: QuestionType[] = [
	...
	likert(
		'generatingText',
		'Generating portions of text (e.g. using ChatGPT, Google Gemini, Microsoft Copilot)',
		5,
		['Never', 'Very frequently'],
	),
	likert(
		'autoCorrection',
		'Writing with correction suggestions (e.g. Grammarly, Google Docs/MS Word text correction)',
		5,
		['Never', 'Very frequently'],
	),
	likert(
		'autoCompletion',
		'Writing with completion suggestions (e.g. Grammarly, Google Docs/MS Word text prediction)',
		5,
		['Never', 'Very frequently'],
	),
	likert(
		'smartReplies',
		"Using 'smart replies' (e.g. complete-message suggestions in Gmail or Microsoft Outlook)",
		5,
		['Never', 'Very frequently'],
	),
	{
...
export const techDiff = {
	text: 'Did you experience any technical difficulties?',
	responseType: 'text',
	name: 'techDiff',
	optional: true,
	flags: { multiline: true, placeholder: 'optional' },
...
export const otherFinal = {
	text: "Aaaand... we're done! Any feedback or ideas for us? What went well? What could have been better? Was the compensation fair? You may leave this blank.",
	responseType: 'text',
	name: 'other',
	optional: true,
	flags: { multiline: true, placeholder: 'optional' },
