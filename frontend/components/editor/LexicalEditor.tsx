	...
	return (
		...
		>
			<div className={classes.editorContainer}>
				<div className="editor-scrollbar relative h-full resize-none overflow-y-auto text-base caret-zinc-900 outline-none">
					{preamble ? <div className="whitespace-pre-line">{preamble}</div> : null}
					<RichTextPlugin
						contentEditable={
							<ContentEditable className="relative resize-none text-base caret-zinc-900 outline-none" />
						}
